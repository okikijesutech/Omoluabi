  ...
  return (
    <header className="h-16 border-b border-slate-200 bg-white sticky top-0 z-50 flex items-center justify-between px-6">
      <div className="flex items-center gap-4 text-slate-500 font-semibold md:hidden">
        <Link href="/" className="font-bold text-xl text-brand-indigo tracking-tight">
          Omoluabi
        </Link>
      </div>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-2 text-brand-gold font-bold cursor-pointer hover:bg-slate-50 px-3 py-1.5 rounded-xl transition-colors">
