...
describe('Architecture Integrity (Constitutional Guard)', () => {
    ...
    const createTestUser = (email, role) => prisma.user.create({ data: { email, password: 'password', role } });
    const createTestDialect = (name) => prisma.dialect.create({ data: { name } });
